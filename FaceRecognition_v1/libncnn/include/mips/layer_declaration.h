...
#include "layer/mips/absval_mips.h"
namespace ncnn {
class AbsVal_final : virtual public AbsVal, virtual public AbsVal_mips
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = AbsVal::create_pipeline(opt); if (ret) return ret; }
        { int ret = AbsVal_mips::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = AbsVal_mips::destroy_pipeline(opt); if (ret) return ret; }
...
#include "layer/mips/bias_mips.h"
namespace ncnn {
class Bias_final : virtual public Bias, virtual public Bias_mips
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Bias::create_pipeline(opt); if (ret) return ret; }
        { int ret = Bias_mips::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Bias_mips::destroy_pipeline(opt); if (ret) return ret; }
...
#include "layer/mips/clip_mips.h"
namespace ncnn {
class Clip_final : virtual public Clip, virtual public Clip_mips
{
public:
    virtual int create_pipeline(const Option& opt) {
        { int ret = Clip::create_pipeline(opt); if (ret) return ret; }
        { int ret = Clip_mips::create_pipeline(opt); if (ret) return ret; }
        return 0;
    }
    virtual int destroy_pipeline(const Option& opt) {
        { int ret = Clip_mips::destroy_pipeline(opt); if (ret) return ret; }
